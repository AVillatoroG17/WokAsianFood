...
const OrdenesPage: React.FC = () => {
    ...
    const handleSubmitOrder = async () => {
        ...
        try {
            ...
            const nuevaOrden = await createOrden(ordenDTO);  // ✅ DESCOMENTADO
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        {mesas.map(mesa => (
            <div
                ...
                className={`p-4 rounded-lg text-center cursor-pointer transition-transform hover:scale-105 ${mesa.tieneOrdenAbierta ? 'bg-red-400' : 'bg-green-400'
                    }`}
            >
                ...
                <div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <button
                            ...
                            className={`flex flex-col items-center p-4 border-2 rounded-lg ${info.tipoOrden === 'mesa' ? 'border-blue-600 bg-blue-50' : 'border-gray-300'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`flex flex-col items-center p-4 border-2 rounded-lg ${info.tipoOrden === 'takeout' ? 'border-blue-600 bg-blue-50' : 'border-gray-300'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`flex flex-col items-center p-4 border-2 rounded-lg ${info.tipoOrden === 'delivery' ? 'border-blue-600 bg-blue-50' : 'border-gray-300'
                                }`}
                        >
            ...
            <div className="lg:col-span-2">
                ...
                <div className="flex gap-2 mb-4 overflow-x-auto pb-2">
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg whitespace-nowrap ${activeCategory === null ? 'bg-blue-600 text-white' : 'bg-gray-200'
                            }`}
                    >
                        Todos
                    </button>
                    {categorias.map(cat => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg whitespace-nowrap ${activeCategory === cat.id ? 'bg-blue-600 text-white' : 'bg-gray-200'
                                }`}
                        >
                            {cat.nombre}
                        </button>
