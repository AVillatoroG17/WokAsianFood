...
import com.wokAsianF.demo.config.EstadoPreparacionConverter;
...
public class OrdenPlatillo {
    ...
    public Integer getOrdenPlatilloId() {
        return ordenPlatilloId;
    }

    public void setOrdenPlatilloId(Integer ordenPlatilloId) {
        this.ordenPlatilloId = ordenPlatilloId;
    }
    ...
    public LocalDateTime getHoraEnvioCocina() {
        return horaEnvioCocina;
    }

    public void setHoraEnvioCocina(LocalDateTime horaEnvioCocina) {
        this.horaEnvioCocina = horaEnvioCocina;
    }

    public LocalDateTime getHoraInicioPreparacion() {
        return horaInicioPreparacion;
    }

    public void setHoraInicioPreparacion(LocalDateTime horaInicioPreparacion) {
        this.horaInicioPreparacion = horaInicioPreparacion;
    }

    public LocalDateTime getHoraFinPreparacion() {
        return horaFinPreparacion;
    }

    public void setHoraFinPreparacion(LocalDateTime horaFinPreparacion) {
        this.horaFinPreparacion = horaFinPreparacion;
    }

    public LocalDateTime getHoraServido() {
        return horaServido;
    }

    public void setHoraServido(LocalDateTime horaServido) {
        this.horaServido = horaServido;
    }

    public Usuario getCocineroAsignado() {
        return cocineroAsignado;
    }

    public void setCocineroAsignado(Usuario cocineroAsignado) {
        this.cocineroAsignado = cocineroAsignado;
    }

    public String getNotasPlatillo() {
        return notasPlatillo;
    }

    public void setNotasPlatillo(String notasPlatillo) {
        this.notasPlatillo = notasPlatillo;
    }
